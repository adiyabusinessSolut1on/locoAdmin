                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {awarenessTag.map((tag: any) => (
                                            <div key={tag._id} className="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-md flex items-center gap-2">
                                                {tag?.title}
                                                <button onClick={() => setAwarenessTag((prev) => prev.filter((item: any) => item._id !== tag._id))} className="text-red-500 hover:text-red-700">
                                                    &times;
                                                </button>
                                            </div>
                                        ))}
                                ...
                                <>
                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {blogTag.map((tag: any) => (
                                            <div key={tag._id} className="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-md flex items-center gap-2">
                                                {tag.title}
                                                <button onClick={() => setBlogTag((prev) => prev.filter((item: any) => item._id !== tag._id))} className="text-red-500 hover:text-red-700">
                                                    &times;
                                                </button>
                                            </div>
                                        ))}
                                ...
                                <>
                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {videoTag.map((tag: any) => (
                                            <div key={tag._id} className="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-md flex items-center gap-2">
                                                {tag.title}
                                                <button onClick={() => setVideoTag((prev) => prev.filter((item: any) => item._id !== tag._id))} className="text-red-500 hover:text-red-700">
                                                    &times;
                                                </button>
                                            </div>
                                        ))}
                                ...
                                <>
                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {quizTag.map((tag: any) => (
                                            <div key={tag._id} className="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-md flex items-center gap-2">
                                                {tag.title}
                                                <button onClick={() => setQuizTag((prev) => prev.filter((item: any) => item._id !== tag._id))} className="text-red-500 hover:text-red-700">
                                                    &times;
                                                </button>
                                            </div>
                                        ))}
                                ...
                                <>
                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {testTag.map((tag: any) => (
                                            <div key={tag._id} className="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-md flex items-center gap-2">
                                                {tag.title}
                                                <button onClick={() => setTestTag((prev) => prev.filter((item: any) => item._id !== tag._id))} className="text-red-500 hover:text-red-700">
                                                    &times;
                                                </button>
                                            </div>
                                        ))}
