...
const Details = () => {
  ...
  const currentDetails = [
    {
      Mutulpost: "4 on 24-07-20223",
      FeedPost: "6 on 25-07-2024",
      Comments: 5,
      Likes: 4,
      _id: "123456",
    },
    {
      Mutulpost: "5 on 26-08-2023",
      FeedPost: "5 on 24-07-20223",
      Comments: 5,
      Likes: 4,
      _id: "123457",
    },
    {
      Mutulpost: "6 on 12-09-2023",
      FeedPost: "7 on 12-09-2023",
      Comments: 5,
      Likes: 4,
      _id: "123458",
    },
    {
      Mutulpost: "7 on 16-09-2023",
      FeedPost: "9 on 16-09-2023",
      Comments: 5,
      Likes: 4,
      _id: "123459",
    },
  ...
  console.log(currentDetails, "pagination");
  ...
  const detailsHeading = ["Mutul post", "Feed Post", "Comments", "Likes"];
  return (
    <React.Fragment>
      {isLoading && <Loader />}
      <ToastContainer />
      <>
        ...
        >
          ...
          >
            ...
            >
              {/* min-w-[900px] */}
              <section className="grid gap-4 p-2 pb-2 min-w-[600px] font-medium border-gray-100 grid-cols-customDetails md:font-semibold font-mavenPro bg-white">
                <p className="pl-2 text-gray-600 md:text-lg">SrNo.</p>
                {/* <p className="pl-10 text-gray-600 md:text-lg">Logo</p> */}

                {detailsHeading?.map((heading: string, index: number) => (
                  <p
                    key={index}
              ...
              <div className=" h-[380px] overflow-y-auto [&::-webkit-scrollbar]:hidden min-w-[600px] bg-gray-50">
                {currentDetails?.map((detail: PostDetails, i: number) => (
                  <section
                    key={i}
                    className="grid items-center gap-6 py-2 pl-6 pr-4 border-t-2 border-gray-200 grid-cols-customDetails group hover:bg-gray-50"
                  >
                    <span>{i + 1}</span>
