              ...
              <div className="grid grid-cols-1 gap-2 py-4 md:grid-cols-2 md:gap-4 ">
                ...
                <div className="w-full md:col-span-2">
                  <div className="flex">
                    ...
                    <button
                      type="button"
                      className="px-2 py-2 ml-2 text-white bg-blue-600 rounded-md hover:bg-blue-500"
                      onClick={generatePassword}
                    >
                      <MdOutlineGeneratingTokens className="w-6 h-6" />
                    </button>
                  </div>
                  <p className="mt-1 text-xs font-bold text-gray-600">
                    Enter Password or Click on button to generate Password
                  </p>
                </div>
              </div>
